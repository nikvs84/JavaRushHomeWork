...
//            File your_file_name = File.createTempFile("your_file_name", null);
            java.lang.String your_file_name = "d:\\a02.txt";
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            writer.print(this.string1.number);
            writer.println();
            writer.print(this.string2.number);
            writer.close();
        }
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            this.string1.number = Integer.parseInt(s);
            s = reader.readLine();
            this.string2.number = Integer.parseInt(s);
            reader.close();
        }
    }
