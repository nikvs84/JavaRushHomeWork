...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory {
        ...
        public AmigoThreadFactory() {
            ...
            this.factoryNumber.incrementAndGet();
        }
        ...
        public Thread newThread(Runnable r) {
            ...
            int avegagePriority = Math.round((maxPriority + minPriority) / 2);
            thread.setPriority(avegagePriority);
            threadNumber.incrementAndGet();
            String threadName = String.format("%s-pool-%s-thread-%s", thread.getThreadGroup().getName(), factoryNumber.toString(), threadNumber.toString());
