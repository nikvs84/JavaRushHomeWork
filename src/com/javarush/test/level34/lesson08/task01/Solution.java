...
public class Solution {
    ...
    public static class Helper {
        ...
        public List<PhantomReference<Monkey>> getFilledList() {
            ArrayList<PhantomReference<Monkey>> phantomReferenceArrayList = new ArrayList<>();
            for (int i = 0; i < 200; i++) {
                phantomReferenceArrayList.add(new PhantomReference<>(new Monkey(), getQueue()));
            }
            return phantomReferenceArrayList;
        }
