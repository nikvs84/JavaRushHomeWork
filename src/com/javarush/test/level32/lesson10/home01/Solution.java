...
public class Solution {
    ...
    public static Thread CLIENT_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                DoubleString doubleStringImpl = (DoubleString) registry.lookup(UNIC_BINDING_NAME);
//                Registry reg = LocateRegistry.getRegistry(null, 2099);
//                DoubleString doubleStringImpl = (DoubleString) reg.lookup(UNIC_BINDING_NAME);
                System.out.println(doubleStringImpl.doubleString("test"));
