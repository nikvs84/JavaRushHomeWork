...
public class Solution {
    ...
    public static class DataAdapter implements RowItem {
        ...
        public String getContactLastName() {
            String sn = contact.getName().split(", ")[0];
            return sn;
        }
...
//            String dial = "callto://" + number.substring(0, 3) + number.substring(4, 7) + number.substring(8, 11) + number.substring(12, 14) + number.substring(15);
//            return dial;
