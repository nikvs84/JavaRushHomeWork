...
public class Solution {
    ...
    public static class Clock extends Thread {
        ...
        private void printTime() throws InterruptedException {
            ...
            sleep(1000);    /*Условие задачи не соответствует проверке на сервере!!!*/
            seconds++;      /*Для того, чтобы время выводилось начиная с установленного в конструкторе, эти 2 строки должны быть в конце кода метода*/
            if(seconds == 60) {
                seconds = 0;
                minutes++;
                if (minutes == 60) {
