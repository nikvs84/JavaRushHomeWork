...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        reader.close();
        System.out.println(consolReader1.getName() + ": " + consolReader1.isInterrupted());
        System.out.println(consolReader2.getName() + ": " + consolReader1.isInterrupted());
        System.out.println(consolReader3.getName() + ": " + consolReader1.isInterrupted());
    }
